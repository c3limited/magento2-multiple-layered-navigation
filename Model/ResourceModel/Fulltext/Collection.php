...
/**
 * NOTE: This class has been modified by C3Media.
 * Originally this class inherited from \Magento\CatalogSearch\Model\ResourceModel\Fulltext\Collection however
 * due to an issue with the ordering of products we needed to be able to modify the code inside the method
 * _renderFiltersBefore. This in turn called multiple other private methods. We therefore decided to basically
 * duplciate all of the logic from that original class and make our modifications. The issue related can be
 * found here https://github.com/magento/magento2/issues/12860.
 *
 * Fulltext Collection
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        // @mod Start comment out sort order
    ...
    /**
     * @mod Add new method according to
     * https://github.com/magento/magento2/commit/045b95c50bce57f67264337865b63af4dfb8782d
     *
     * @inheritdoc
     */
